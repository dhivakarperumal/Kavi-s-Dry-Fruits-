...
exports.addProduct = async (req, res) => {
  try {
    const {
      productId, name, category, rating, barcode, barcodeValue,
      productType, images, variants, comboItems, comboDetails, totalStock
    } = req.body;

    const [result] = await db.query(
      `INSERT INTO products 
      (productId, name, category, rating, barcode, barcodeValue, productType, images, variants, comboItems, comboDetails, totalStock) 
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        productId, name, category, rating, barcode, barcodeValue, productType,
