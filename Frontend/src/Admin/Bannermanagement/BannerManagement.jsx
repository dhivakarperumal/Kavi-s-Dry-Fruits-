        ...
        <div className="space-y-6 p-8 animate-in fade-in slide-in-from-bottom-4 duration-700 min-h-[600px]">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    <button onClick={() => handleOpenModal()} className="flex items-center justify-center gap-2 bg-[#009669] hover:bg-[#009669] text-white px-5 py-2.5 rounded-lg font-bold transition-all shadow-lg shadow-purple-200 active:scale-95"><FiPlus /> New Promotion</button>
                </div>
            </div>
                    ...
                    {viewMode === "table" ? <div className="overflow-x-auto hide-scrollbar">
                        <table className="w-full text-left border-collapse block md:table">
                            <thead className="hidden md:table-header-group">
                                <tr className="bg-gradient-to-r from-[#009669] to-[#009669]">
                                    <th className="px-4 py-4 text-xs font-black text-[#fff] uppercase tracking-wider text-center">S No</th>
                                    <th className="px-6 py-4 text-xs font-black text-[#fff] uppercase tracking-wider">Visual Assets</th>
                                    <th className="px-6 py-4 text-xs font-black text-[#fff] uppercase tracking-wider">Promotion Details</th>
                                    <th className="px-6 py-4 text-xs font-black text-[#fff] uppercase tracking-wider">Configuration</th>
                                    <th className="px-6 py-4 text-xs font-black text-[#fff] uppercase tracking-wider text-right">Actions</th>
                                </tr>
                            </thead>
