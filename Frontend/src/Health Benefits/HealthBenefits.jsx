                ...
                >
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
                    ...
                    <div className="pt-1 flex items-center gap-2">
                      ...
                      <button
                        onClick={() => openModal(item, 'benefits')}
                        className="flex-1 inline-flex items-center justify-center gap-1 py-2 px-1.7 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold transition-all shadow-xs shadow-emerald-700/20 cursor-pointer"
        ...
        >
          ...
          >
            ...
            <div className="p-3 sm:p-5 border-t border-stone-100 bg-stone-50/80 flex items-center justify-between gap-3 shrink-0">
              ...
              <Link
                to={selectedProduct.productId || selectedProduct.id ? `/shop/${selectedProduct.productId || selectedProduct.id}` : '/shop'}
                onClick={closeModal}
